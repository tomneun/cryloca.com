...
import { ShoppingBag, Shield, Eye, ExternalLink } from 'lucide-react';
...
const Index = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Check if pseudonym has a paid license
    const licenses = JSON.parse(localStorage.getItem('vendor_licenses') || '[]');
    const userLicense = licenses.find((license: any) => 
      license.username === pseudonym && license.status === 'paid'
    );

    if (!userLicense) {
      setError('Kein gültiges Vendor-Lizenz für dieses Pseudonym gefunden. Bitte kaufen Sie zuerst eine Lizenz.');
      return;
    }
      ...
      <div className="min-h-screen bg-gray-900 text-gray-100">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-2xl font-bold">NO LIMIT CENTER</h1>
              </div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6">Lizenzierter Marktplatz</h2>
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Verkaufen und kaufen Sie digitale Güter über ein sicheres, lizenziertes System
            </p>
            <div className="flex justify-center gap-8 text-sm text-gray-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Lizenzierte Verkäufer</span>
              </div>
              <div className="flex items-center gap-2">
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Lizenzierter Marktplatz</p>
        </div>

        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <h2 className="text-xl font-semibold mb-6 text-center">Vendor Login</h2>
          ...
          <div className="mt-6 text-center">
            ...
            <Button 
              ...
              className="border-gray-600 text-gray-300 hover:bg-gray-700"
            >
              Regeln & Lizenz kaufen
            </Button>
          </div>

          <div className="mt-6 text-xs text-gray-400 space-y-1">
            <p>• Vendor-Lizenz erforderlich für Shop-Zugang</p>
            <p>• Session wird lokal gespeichert</p>
            <p>• Sichere, lizenzierte Plattform</p>
          </div>
        </div>
      </div>
    </div>

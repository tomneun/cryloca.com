...
const BuySellChoice = ({
  ...
  return <div className="bg-gray-800 rounded-lg p-8 border border-gray-700 max-w-md mx-auto">
      ...
      <div className="space-y-4">
        <Button onClick={() => onChoice('buyer')} className="w-full bg-red-600 hover:bg-red-700 py-4 text-lg">
          <ShoppingBag className="h-6 w-6 mr-3" />
          Ich bin ein Käufer
        </Button>
        
        <Button onClick={() => onChoice('seller')} variant="outline" className="w-full border-gray-600 hover:bg-gray-700 py-4 text-lg text-slate-400">

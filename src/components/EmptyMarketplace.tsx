...
const EmptyMarketplace = ({ session }: EmptyMarketplaceProps) => {
  ...
  return (
    <div className="text-center py-8">
      ...
      <h3 className="text-lg font-semibold text-gray-400 mb-2">Noch keine Shops verfügbar</h3>
      <p className="text-gray-500 text-sm">Seien Sie der Erste, der einen Shop erstellt!</p>
      {session && (
